...
let CodeActionController = class CodeActionController extends Disposable {
    ...
    constructor(editor, markerService, contextKeyService, instantiationService, languageFeaturesService, progressService, _commandService, _configurationService, _actionWidgetService, _instantiationService, _telemetryService, _progressService) {
        super();
